...
function RComp() {
    ...
    const allReviews = [
        ...
        },
        {
            user:r4,
            name:"Vanita Shenkar",
            review:"Payments are always on time, which builds a lot of trust.",
            rate:4
        },
        {
            user:r5,
        ...
        },
        {
            ...
            review:"Payments were always on time. That gave me a lot of peace of mind.",
            rate:4
        },
        {
            user:r7,
        ...
        },
        {
            user:r12,
            name:"VIVEK SINGH",
            review:"The instructions were clear, the support team was patient, and the payments were prompt.",
            rate:4
        },
        {
            user:r13,
        ...
        },
        {
            user:r17,
            name:"Jagruti Rahate",
            review:"Payment and communication were always straightforward and honest.",
            rate:4
        },
        {
            user:r18,
            name:"Suraj Suryawanshi",
            review:"Such a smooth payment process. Definitely trustworthy.",
            rate:4
        },
        {
            user:r19,
            name:"Sayali Ghanot",
            review:"Clear work, clear expectations, and clear payments.",
            rate:4
        },
        {
            user:r20,
      ...
      <div className='myrs2' data-aos="fade-left">
        ...
        <div className='names'>
          ...
          <div className='starts'>
            <label style={{ color: 'white', }}>4.1</label>
